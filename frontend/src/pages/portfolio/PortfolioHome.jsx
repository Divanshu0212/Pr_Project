            ...
            <div className="max-w-6xl mx-auto">
                                        ...
                                        <div className="bg-[#161B22] rounded-lg p-6 max-w-md w-full mx-4 top-[calc(-500px)] relative">
                                            ...
                                            <div className="flex gap-4">
                                                <button
                                                    ...
                                                    className="flex-1 py-2 bg-gradient-to-r from-[#00FFFF] to-[#9C27B0] text-black font-medium rounded-lg hover:opacity-90 transition-opacity flex items-center justify-content-center gap-2">
                ...
                <div className="mb-16 animate-on-scroll">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-[#00FFFF] text-black rounded hover:opacity-90 transition-opacity mb-8 mt-8"
                    >
                ...
                <div className="mb-6 animate-on-scroll">
                    <div className="filter-tabs flex gap-4 border-b pb-2"
                        style={{ borderColor: `rgba(var(--color-accent-primary), 0.2)` }}>
                        <button
